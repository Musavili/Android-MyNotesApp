...
public final class NoteInfo implements Parcelable{
    ...
    protected NoteInfo(Parcel in) {
        mCourse = in.readParcelable(CourseInfo.class.getClassLoader());//pass in the class loader for that class
    ...
    @Override//parcelable to describe special behaviours for our parcel
