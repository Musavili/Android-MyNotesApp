...
public class NoteRecyclerAdapter extends RecyclerView.Adapter<NoteRecyclerAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = mLayoutInflater.inflate(R.layout.item_note_list, parent, false);//inflate the views
    ...
    class ViewHolder extends RecyclerView.ViewHolder {//the custom viewHolder with its children views as fields
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            mTextTitle = (TextView) itemView.findViewById(R.id.text_title); //itemView file
